...
public class TwoDimensionScrollView extends FrameLayout {
    ...
    public TwoDimensionScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        /// get system constants thresholds
    ...
    protected void measureChildWithMargins(View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        int childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(layoutParams.leftMargin + layoutParams.rightMargin, MeasureSpec.UNSPECIFIED);
        int childHeightMeasureSpec = MeasureSpec.makeMeasureSpec(layoutParams.topMargin + layoutParams.bottomMargin, MeasureSpec.UNSPECIFIED);
